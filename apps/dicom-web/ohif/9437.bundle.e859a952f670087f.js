"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[9437], {
48284(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: basicTestLayout, basicTestRoute, initToolGroups, modeInstance
...
// tool defs
{
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Window Level'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Window Level'),
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Zoom'),
    commands: setToolActiveToolbar,
    evaluate: 'evaluate.cornerstoneTool'
  }
}, {
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Pan'),
    commands: setToolActiveToolbar,
    evaluate: 'evaluate.cornerstoneTool'
  }
}, {
  ...
  props: {
    icon: 'icon-mpr',
    label: i18next/* ["default"].t */.A.t('Buttons:MPR'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:MPR'),
    commands: {
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:3D Rotate'),
    commands: setToolActiveToolbar
  }
}, {
  id: 'Capture',
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Capture'),
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Crosshairs'),
    commands: {
      commandName: 'setToolActiveToolbar',
      commandOptions: {
        toolGroupIds: ['mpr']
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Rectangle'),
    commands: setToolActiveToolbar,
    evaluate: 'evaluate.cornerstoneTool'
  }
}, {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/mode-test"}')
 ...
 */
const modeInstance = {
  ...basic_src/* .modeInstance */.dw,
  id: id,
  routeName: 'basic-test',
  displayName: i18next/* ["default"].t */.A.t('Modes:Basic Test Mode'),
...
/* export default */ const basic_test_mode_src = (mode);
