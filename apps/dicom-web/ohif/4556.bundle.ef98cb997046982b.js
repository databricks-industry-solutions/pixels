"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[4556], {
78903(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// tool defs
{
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Rotate Right +90'),
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Flip Horizontally'),
  ...
  props: {
    icon: 'tool-invert',
    label: i18next/* ["default"].t */.A.t('Buttons:Invert Colors'),
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Calibration Line'),
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/mode-basic-dev-mode"}')
...
const configs = (/* unused pure expression or super */ null && ({
  Length: {}
  //
}));
const ohif = {
...
function modeFactory({
  ...
  return {
    id: id,
    routeName: 'dev',
    displayName: i18next/* ["default"].t */.A.t('Modes:Basic Dev Viewer'),
    /**
     * Lifecycle hooks
     */
    onModeEnter: ({
