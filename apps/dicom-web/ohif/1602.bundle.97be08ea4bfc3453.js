"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[1602], {
42061(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-cornerstone-dynamic-volume"}')
...
const SEG_CHART_INSTANCE_UID = src/* .utils.guid */.Wp.guid();
...
function _getInstanceFromSegmentations(segmentations, {
  ...
  const instance = {
    ...
    SOPInstanceUID: src/* .utils.guid */.Wp.guid(),
...
const Header = ({
  ...
  asChild: true
}, /*#__PURE__*/react.createElement("span", null, /*#__PURE__*/react.createElement(ui_next_src/* .Icons.ByName */.FI1.ByName, {
  name: "info-link",
...
const DynamicVolumeControls = ({
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    defaultOpen: true
  }, /*#__PURE__*/react.createElement(ui_next_src/* .PanelSection.Header */.aUM.Header, null, "Controls"), /*#__PURE__*/react.createElement(ui_next_src/* .PanelSection.Content */.aUM.Content, {
    ...
    className: "mt-2 w-full"
  }, /*#__PURE__*/react.createElement(ui_next_src/* .Numeric.Container */.ewR.Container, {
    mode: "doubleRange",
    min: 1,
    max: numDimensionGroups || 1,
    values: rangeValues || [1, numDimensionGroups || 1],
    onChange: onDoubleRangeChange || (() => {})
  }, /*#__PURE__*/react.createElement(ui_next_src/* .Numeric.DoubleRange */.ewR.DoubleRange, {
...
/* export default */ const panels_DynamicVolumeControls = (DynamicVolumeControls);
function DimensionGroupControls({
  ...
  }, /*#__PURE__*/react.createElement(ui_next_src/* .Numeric.NumberStepper */.ewR.NumberStepper, {
    className: "h-[28px] w-[58px]",
    direction: "horizontal"
  }), /*#__PURE__*/react.createElement(ui_next_src/* .Numeric.Label */.ewR.Label, {
    className: "text-muted-foreground mt-1 text-sm"
  }, "Frame"))), /*#__PURE__*/react.createElement(ui_next_src/* .Numeric.Container */.ewR.Container, {
    mode: "stepper",
    value: fps || 1,
...
/* export default */ const panels_DynamicDataPanel = (DynamicDataPanel);
...
/* export default */ const panels_WorkflowPanel = ((/* unused pure expression or super */ null && (WorkflowPanel)));
...
function DynamicExport({
  ...
  const segmentations = (0,cornerstone_src/* .useSegmentations */.jo)({
    servicesManager
  });
  if (!segmentations?.length) {
    return null;
  ...
  }, /*#__PURE__*/react.createElement(ui_next_src/* .Icons.Export */.FI1.Export, null), /*#__PURE__*/react.createElement("span", {
    className: "pl-1"
...
/* export default */ const panels_DynamicExport = (DynamicExport);
...
function getPanelModule({
  ...
  const wrappedDynamicSegmentation = () => {
    ...
    }), /*#__PURE__*/react.createElement(cornerstone_src/* .PanelSegmentation */.rE, {
      servicesManager: servicesManager,
      commandsManager: commandsManager,
      extensionManager: extensionManager,
