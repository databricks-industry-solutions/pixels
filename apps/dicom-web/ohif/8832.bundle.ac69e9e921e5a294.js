"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[8832], {
4671(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-dicom-microscopy"}')
...
// EXTERNAL MODULE: ../../../extensions/dicom-microscopy/node_modules/mathjs/lib/esm/index.js + 1009 modules
var esm = __webpack_require__(26283);
...
/* export default */ const utils_styles = (styles);
...
/* export default */ const viewerManager = (ViewerManager);
...
/* export default */ const utils_RoiAnnotation = (RoiAnnotation);
...
const DEVICE_OBSERVER_UID_uid = '2.25.285241207697168520771311899641885187923';
/* export default */ const DEVICE_OBSERVER_UID = (DEVICE_OBSERVER_UID_uid);
...
function constructSR(metadata, {
  ...
  const observationContext = new dcmjs_es/* ["default"].sr.templates.ObservationContext */.Ay.sr.templates.ObservationContext({
    observerPersonContext: new dcmjs_es/* ["default"].sr.templates.ObserverContext */.Ay.sr.templates.ObserverContext({
      observerType: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
        value: '121006',
        schemeDesignator: 'DCM',
        meaning: 'Person'
      }),
      observerIdentifyingAttributes: new dcmjs_es/* ["default"].sr.templates.PersonObserverIdentifyingAttributes */.Ay.sr.templates.PersonObserverIdentifyingAttributes({
        name: '@ohif/extension-dicom-microscopy'
      })
    }),
    observerDeviceContext: new dcmjs_es/* ["default"].sr.templates.ObserverContext */.Ay.sr.templates.ObserverContext({
      observerType: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
        value: '121007',
        schemeDesignator: 'DCM',
        meaning: 'Device'
      }),
      observerIdentifyingAttributes: new dcmjs_es/* ["default"].sr.templates.DeviceObserverIdentifyingAttributes */.Ay.sr.templates.DeviceObserverIdentifyingAttributes({
        uid: DEVICE_OBSERVER_UID
      })
    }),
    subjectContext: new dcmjs_es/* ["default"].sr.templates.SubjectContext */.Ay.sr.templates.SubjectContext({
      subjectClass: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
        value: '121027',
        schemeDesignator: 'DCM',
        meaning: 'Specimen'
      }),
      subjectClassSpecificContext: new dcmjs_es/* ["default"].sr.templates.SubjectContextSpecimen */.Ay.sr.templates.SubjectContextSpecimen({
  ...
  for (let i = 0; i < annotations.length; i++) {
    ...
    measurements = measurements.map(measurement => {
      ...
      return new dcmjs_es/* ["default"].sr.valueTypes.NumContentItem */.Ay.sr.valueTypes.NumContentItem({
        name: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
        ...
        unit: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
    ...
    evaluations = evaluations.map(evaluation => {
      ...
      return new dcmjs_es/* ["default"].sr.valueTypes.TextContentItem */.Ay.sr.valueTypes.TextContentItem({
        name: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
          value: ConceptName.CodeValue,
          meaning: ConceptName.CodeMeaning,
          schemeDesignator: ConceptName.CodingSchemeDesignator
    ...
    const group = new dcmjs_es/* ["default"].sr.templates.PlanarROIMeasurementsAndQualitativeEvaluations */.Ay.sr.templates.PlanarROIMeasurementsAndQualitativeEvaluations({
      trackingIdentifier: new dcmjs_es/* ["default"].sr.templates.TrackingIdentifier */.Ay.sr.templates.TrackingIdentifier({
        uid: roi.uid,
        identifier: presentationState ? identifier.concat(`(${JSON.stringify(presentationState)})`) : identifier
      }),
      referencedRegion: new dcmjs_es/* ["default"].sr.contentItems.ImageRegion3D */.Ay.sr.contentItems.ImageRegion3D({
        graphicType: roi.scoord3d.graphicType,
        graphicData: roi.scoord3d.graphicData,
        frameOfReferenceUID: roi.scoord3d.frameOfReferenceUID
      }),
      findingType: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
        value: label,
  ...
  const measurementReport = new dcmjs_es/* ["default"].sr.templates.MeasurementReport */.Ay.sr.templates.MeasurementReport({
    languageOfContentItemAndDescendants: new dcmjs_es/* ["default"].sr.templates.LanguageOfContentItemAndDescendants */.Ay.sr.templates.LanguageOfContentItemAndDescendants({}),
    observationContext,
    procedureReported: new dcmjs_es/* ["default"].sr.coding.CodedConcept */.Ay.sr.coding.CodedConcept({
      value: '112703',
      schemeDesignator: 'DCM',
  ...
  const dataset = new dcmjs_es/* ["default"].sr.documents.Comprehensive3DSR */.Ay.sr.documents.Comprehensive3DSR({
    content: measurementReport[0],
    evidence: [metadata],
    seriesInstanceUID: dcmjs_es/* ["default"].data.DicomMetaDictionary.uid */.Ay.data.DicomMetaDictionary.uid(),
    seriesNumber: SeriesNumber,
    seriesDescription: SeriesDescription || 'Whole slide imaging structured report',
    sopInstanceUID: dcmjs_es/* ["default"].data.DicomMetaDictionary.uid */.Ay.data.DicomMetaDictionary.uid(),
    instanceNumber: 1,
  ...
  dataset._meta = {
    ...
    ImplementationClassUID: {
      Value: [dcmjs_es/* ["default"].data.DicomMetaDictionary.uid */.Ay.data.DicomMetaDictionary.uid()],
      vr: 'UI'
    },
...
function MicroscopyPanel(props) {
  ...
  }, data.map(item => /*#__PURE__*/react.createElement(src/* .DataRow */.x3Y, {
    key: item.uid,
    number: item.index + 1,
    title: item.label,
...
/* export default */ const MicroscopyPanel_MicroscopyPanel = (connectedMicroscopyPanel);
...
function getCommandsModule({
  ...
  const actions = {
    ...
    setLabel: async ({
      ...
      const value = await (0,default_src/* .callInputDialog */.l5)({
        uiDialogService,
        title: i18n_src/* ["default"].t */.A.t('Tools:Edit Measurement Label'),
        placeholder: roiAnnotation.label || i18n_src/* ["default"].t */.A.t('Tools:Enter new label'),
...
;// CONCATENATED MODULE: ../../../extensions/dicom-microscopy/src/getCustomizationModule.ts
...
/* export default */ const dcmCodeValues = (DCM_CODE_VALUES);
...
const MeasurementReport = dcmjs_es/* ["default"].adapters.DICOMMicroscopyViewer.MeasurementReport */.Ay.adapters.DICOMMicroscopyViewer.MeasurementReport;
...
var dicomWebClient = __webpack_require__(37237);
;// CONCATENATED MODULE: ../../../extensions/dicom-microscopy/src/utils/loadAnnotation.js
...
;// CONCATENATED MODULE: ../../../extensions/dicom-microscopy/src/DicomMicroscopyANNSopClassHandler.js



const {
  utils: DicomMicroscopyANNSopClassHandler_utils
} = core_src/* ["default"] */.Ay;
const DicomMicroscopyANNSopClassHandler_SOP_CLASS_UIDS = {
  MICROSCOPY_BULK_SIMPLE_ANNOTATION: '1.2.840.10008.5.1.4.1.1.91.1'
};
const DicomMicroscopyANNSopClassHandler_SOPClassHandlerId = '@ohif/extension-dicom-microscopy.sopClassHandlerModule.DicomMicroscopyANNSopClassHandler';
function DicomMicroscopyANNSopClassHandler_getDisplaySetsFromSeries(instances, servicesManager, extensionManager) {
  // If the series has no instances, stop here
  if (!instances || !instances.length) {
    throw new Error('No instances were provided');
  }
  ...
  const displaySet = {
    ...
    displaySetInstanceUID: DicomMicroscopyANNSopClassHandler_utils.uuidv4(),
    SOPInstanceUID,
    SeriesInstanceUID,
    StudyInstanceUID,
    SOPClassHandlerId: DicomMicroscopyANNSopClassHandler_SOPClassHandlerId,
    SOPClassUID,
    SeriesDescription,
    // Map the content date/time to the series date/time, these are only used for filtering.
    SeriesDate: ContentDate,
...
function getDicomMicroscopyANNSopClassHandler({
  ...
  const getDisplaySetsFromSeries = instances => {
    return DicomMicroscopyANNSopClassHandler_getDisplaySetsFromSeries(instances, servicesManager, extensionManager);
  };
  return {
    name: 'DicomMicroscopyANNSopClassHandler',
    sopClassUids: [DicomMicroscopyANNSopClassHandler_SOP_CLASS_UIDS.MICROSCOPY_BULK_SIMPLE_ANNOTATION],
    getDisplaySetsFromSeries
  };
}
...
const Component = /*#__PURE__*/react.lazy(() => {
  return __webpack_require__.e(/* import() */ 5189).then(__webpack_require__.bind(__webpack_require__, 40292));
});
...
const extension = {
  ...
  getViewportModule({
    ...
    const ExtendedMicroscopyViewport = props => {
      ...
      const onResize = lodash_debounce_default()(() => {
        const {
          microscopyService
        } = servicesManager.services;
  ...
  getSopClassHandlerModule(params) {
    return [getDicomMicroscopySRSopClassHandler(params), getDicomMicroscopyANNSopClassHandler(params)];
  },
  getPanelModule: getPanelModule,
  getCommandsModule: getCommandsModule,
  getCustomizationModule: getCustomizationModule
};
/* export default */ const dicom_microscopy_src = (extension);

},
37237(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (getDicomWebClient)
});
/* import */ var _ohif_core__rspack_import_0 = __webpack_require__(50679);
/* import */ var _default_src_DatabricksPixelsDicom_StaticWadoClient__rspack_import_1 = __webpack_require__(37658);
...
function getDicomWebClient({
  ...
  const wadoConfig = {
    ...
    errorInterceptor: _ohif_core__rspack_import_0/* .errorHandler.getHTTPErrorHandler */.r_.getHTTPErrorHandler()
  };
  const client = new _default_src_DatabricksPixelsDicom_StaticWadoClient__rspack_import_1/* ["default"] */.A(wadoConfig);
  ...
  if (extensionManager.activeDataSourceName === 'dicomlocal') {
    ...
    client.retrieveInstanceFrames = async options => {
      ...
      const instance = _ohif_core__rspack_import_0.DicomMetadataStore.getInstance(options.studyInstanceUID, options.seriesInstanceUID, options.sopInstanceUID);
