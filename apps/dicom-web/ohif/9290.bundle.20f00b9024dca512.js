"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[9290], {
85201(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/mode-microscopy"}')
...
const toolbarButtons = [{
  ...
  props: {
    icon: 'tool-length',
    label: i18next/* ["default"].t */.A.t('Buttons:Line'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Line Tool'),
  ...
  props: {
    icon: 'tool-point',
    label: i18next/* ["default"].t */.A.t('Buttons:Point'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Point Tool'),
    commands: {
  ...
  props: {
    icon: 'tool-polygon',
    label: i18next/* ["default"].t */.A.t('Buttons:Polygon'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Polygon Tool'),
    commands: {
      ...setToolActiveToolbar,
      commandOptions: {
        toolName: 'polygon'
  ...
  props: {
    icon: 'tool-rectangle',
    label: i18next/* ["default"].t */.A.t('Buttons:Box'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Box Tool'),
    commands: {
      ...setToolActiveToolbar,
      commandOptions: {
        toolName: 'box'
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Freehand Polygon'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Freehand Polygon Tool'),
    commands: {
      ...setToolActiveToolbar,
      commandOptions: {
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Freehand Line'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Freehand Line Tool'),
    commands: {
      ...setToolActiveToolbar,
      commandOptions: {
...
function modeFactory({
  ...
  return {
    ...
    displayName: i18next/* ["default"].t */.A.t('Modes:Microscopy'),
    /**
     * Lifecycle hooks
     */
    onModeEnter: ({
