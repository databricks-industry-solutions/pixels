"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[4996], {
83007(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/mode-monai-label"}')
...
function modeFactory({
  ...
  return {
    ...
    isValidMode: ({
      ...
      return {
        valid: modalitiesArray.includes('CT'),
      ...
      layoutTemplate: ({
        ...
        return {
          ...
          props: {
            ...
            rightPanels: [cornerstone.panelTool, monailabel.monaiLabel, niftiSegmentation.panel],
    ...
    hotkeys: [...src/* .hotkeys.defaults.hotkeyBindings */.ot.defaults.hotkeyBindings]
  };
}
const mode = {
  id: id,
...
/* export default */ const monai_label_src = (mode);
