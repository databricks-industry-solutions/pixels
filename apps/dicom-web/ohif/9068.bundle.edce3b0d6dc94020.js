"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[9068], {
44087(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var SystemProvider = __webpack_require__(62376);
...
function OHIFCornerstoneSRMeasurementViewport(props) {
  ...
  } = (0,cornerstone_src/* .usePositionPresentationStore */.qu)();
  ...
  const getCornerstoneViewport = (0,react.useCallback)(() => {
    ...
    return /*#__PURE__*/react.createElement(cornerstone_src/* .OHIFCornerstoneViewport */.R9, _extends({}, props, {
...
/* export default */ const components_OHIFCornerstoneSRMeasurementViewport = (OHIFCornerstoneSRMeasurementViewport);
...
const contentItemFormatters = {
  ...
  PNAME: contentItem => {
    ...
    return personName ? src/* .utils.formatPN */.Wp.formatPN(personName) : undefined;
  },
  DATE: contentItem => {
    const {
      Date
    } = contentItem;
    return Date ? src/* .utils.formatDate */.Wp.formatDate(Date) : undefined;
  },
  TIME: contentItem => {
    const {
      Time
    } = contentItem;
    return Time ? src/* .utils.formatTime */.Wp.formatTime(Time) : undefined;
  },
  DATETIME: contentItem => {
    ...
    const formattedDate = src/* .utils.formatDate */.Wp.formatDate(dicomDate);
    const formattedTime = src/* .utils.formatTime */.Wp.formatTime(dicomTime);
...
function OHIFCornerstoneSRContentItem(props) {
  ...
  const isFinding = CodeValue === enums/* .CodeNameCodeSequenceValues.Finding */.n7.Finding;
  ...
  if (CodeValue === enums/* .CodeNameCodeSequenceValues.Finding */.n7.Finding) {
...
/* export default */ const components_OHIFCornerstoneSRTextViewport = (OHIFCornerstoneSRTextViewport);
...
/* export default */ const components_OHIFCornerstoneSRViewport = (OHIFCornerstoneSRViewport);
