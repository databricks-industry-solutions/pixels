"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[5406], {
12269(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
function useIdleInterpreter(getMachine, options) {
    ...
    if (false) { var initialMachine, _a }
...
function utils_isInterpreterStateEqual(service, prevState, nextState) {
    if (service.status === es/* .InterpreterStatus.NotStarted */.vy.NotStarted) {
        return true;
    }
...
function useMachine(getMachine) {
    ...
    var getSnapshot = (0,react.useCallback)(function () {
        if (service.status === es/* .InterpreterStatus.NotStarted */.vy.NotStarted) {
            return (options.state
                ? es/* .State.create */.Uw.create(options.state)
                : service.machine.initialState);
        }
    ...
    (0,react.useEffect)(function () {
        var rehydratedState = options.state;
        service.start(rehydratedState ? es/* .State.create */.Uw.create(rehydratedState) : undefined);
        return function () {
            service.stop();
            service.status = es/* .InterpreterStatus.NotStarted */.vy.NotStarted;
        };
    }, []);
...
function useActor_useActor(actorRef, getSnapshot) {
...
function useSelector_useSelector(actor, selector, compare, getSnapshot) {
...
98319(__unused_rspack_module, exports, __webpack_require__) {
/**
 * @license React
...
92380(__unused_rspack_module, exports, __webpack_require__) {
/**
 * @license React
...
var React = __webpack_require__(86326),
  shim = __webpack_require__(73634);
function is(x, y) {
  return (x === y && (0 !== x || 1 / x === 1 / y)) || (x !== x && y !== y);
}
var objectIs = "function" === typeof Object.is ? Object.is : is,
...
73634(module, __unused_rspack_exports, __webpack_require__) {


if (true) {
  module.exports = __webpack_require__(98319);
} else {}


},
61100(module, __unused_rspack_exports, __webpack_require__) {


if (true) {
  module.exports = __webpack_require__(92380);
} else {}


},
29084(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  vy: () => (/* reexport */ interpreter_InterpreterStatus),
  u5: () => (/* reexport */ Machine),
...
var interopSymbols = (utils_a = {}, utils_a[symbolObservable] = function () {
  return this;
}, utils_a[Symbol.observable] = function () {
  return this;
}, utils_a);
...
function stateUtils_getValue(rootNode, configuration) {
...
var registry_children = /*#__PURE__*/new Map();
...
var registry = {
  ...
  register: function (id, actor) {
    registry_children.set(id, actor);
    return id;
  },
  get: function (id) {
    return registry_children.get(id);
  },
  free: function (id) {
    registry_children.delete(id);
  }
};
...
var interpreter_InterpreterStatus;

(function (InterpreterStatus) {
  InterpreterStatus[InterpreterStatus["NotStarted"] = 0] = "NotStarted";
  InterpreterStatus[InterpreterStatus["Running"] = 1] = "Running";
  InterpreterStatus[InterpreterStatus["Stopped"] = 2] = "Stopped";
})(interpreter_InterpreterStatus || (interpreter_InterpreterStatus = {}));

var interpreter_Interpreter =
/*#__PURE__*/
...
function () {
  ...
  function Interpreter(machine, options) {
    ...
    this.initialized = false;
    this.status = interpreter_InterpreterStatus.NotStarted;
    ...
    this.send = function (event, payload) {
      ...
      if (_this.status === interpreter_InterpreterStatus.Stopped) {
        // do nothing
        if (!environment_IS_PRODUCTION) {
      ...
      if (_this.status !== interpreter_InterpreterStatus.Running && !_this.options.deferEvents) {
    ...
    this.sendTo = function (event, to, immediate) {
      ...
      if ('machine' in target) {
        ...
        if (_this.status !== interpreter_InterpreterStatus.Stopped || _this.parent !== target || // we need to send events to the parent from exit handlers of a machine that reached its final state
        _this.state.done) {
    ...
    this._exec = function (action, context, _event, actionFunctionMap) {
      ...
      switch (action.type) {
        ...
        case start:
          {
            if (_this.status !== interpreter_InterpreterStatus.Running) {
              return;
            }
    ...
    this.scheduler = new scheduler_Scheduler({
  ...
  Object.defineProperty(Interpreter.prototype, "state", {
    ...
    get: function () {
      if (!environment_IS_PRODUCTION) {
        utils_warn(this.status !== interpreter_InterpreterStatus.NotStarted, "Attempted to read state from uninitialized service '".concat(this.id, "'. Make sure the service is started first."));
      }
  ...
  Interpreter.prototype.onTransition = function (listener) {
    ...
    if (this.status === interpreter_InterpreterStatus.Running) {
  ...
  completeListener) {
    ...
    if (this.status !== interpreter_InterpreterStatus.NotStarted) {
    ...
    if (this.status === interpreter_InterpreterStatus.Stopped) {
      observer.complete();
    } else {
  ...
  Interpreter.prototype.onDone = function (listener) {
    if (this.status === interpreter_InterpreterStatus.Stopped && this._doneEvent) {
      listener(this._doneEvent);
    } else {
  ...
  Interpreter.prototype.start = function (initialState) {
    ...
    this.initialized = true;
    this.status = interpreter_InterpreterStatus.Running;
  ...
  Interpreter.prototype._stop = function () {
    ...
    this.initialized = false;
    this.status = interpreter_InterpreterStatus.Stopped;
  ...
  Interpreter.prototype.batch = function (events) {
    ...
    if (this.status === interpreter_InterpreterStatus.NotStarted && this.options.deferEvents) {
      // tslint:disable-next-line:no-console
      if (!environment_IS_PRODUCTION) {
    ...
    } else if (this.status !== interpreter_InterpreterStatus.Running) {
...
function interpret(machine, options) {
  var interpreter = new interpreter_Interpreter(machine, options);
  return interpreter;
}
...
function () {
  ...
  StateNode.prototype.resolveTransition = function (stateTransition, currentState, context, predictableExec, _event) {
    ...
    var resolvedStateValue = willTransition ? stateUtils_getValue(this.machine, configuration) : undefined;
...
var schema_t = (/* unused pure expression or super */ null && (createSchema));
