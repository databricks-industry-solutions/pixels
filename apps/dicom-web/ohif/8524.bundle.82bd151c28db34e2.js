"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[8524], {
...
14935(__unused_rspack___webpack_module__, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Mesh: () => (/* reexport */ interface_types_mesh),
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/version.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/pixel-types.js
const PixelTypes = {
    Unknown: 'Unknown',
    Scalar: 'Scalar',
    RGB: 'RGB',
...
/* export default */ const pixel_types = (PixelTypes);
//# sourceMappingURL=pixel-types.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/image-type.js
...
class ImageType {
    ...
    pixelType;
    components;
    constructor(dimension = 2, componentType = int_types/* ["default"].UInt8 */.A.UInt8, pixelType = pixel_types.Scalar, components = 1) {
...
/* export default */ const image_type = (ImageType);
//# sourceMappingURL=image-type.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/set-matrix-element.js
function setMatrixElement(matrixData, columns, row, column, value) {
    matrixData[column + row * columns] = value;
}
/* export default */ const set_matrix_element = (setMatrixElement);
//# sourceMappingURL=set-matrix-element.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/image.js
...
/* export default */ const interface_types_image = (Image);
//# sourceMappingURL=image.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/copy-image.js
...
/* export default */ const copy_image = (copyImage);
//# sourceMappingURL=copy-image.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/image-shared-buffer-or-copy.js
...
/* export default */ const image_shared_buffer_or_copy = (imageSharedBufferOrCopy);
//# sourceMappingURL=image-shared-buffer-or-copy.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/stack-images.js
...
/* export default */ const stack_images = (stackImages);
//# sourceMappingURL=stack-images.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/get-file-extension.js
...
/* export default */ const get_file_extension = (getFileExtension);
//# sourceMappingURL=get-file-extension.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/get-matrix-element.js
function getMatrixElement(matrixData, columns, row, column) {
    return matrixData[column + row * columns];
}
/* export default */ const get_matrix_element = (getMatrixElement);
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/cast-image.js
    ...
    if (inputImage.data !== null) {
        if (typeof options !== 'undefined' && typeof options.componentType !== 'undefined' && options.componentType !== inputImage.imageType.componentType) {
            switch (inputImage.imageType.componentType) {
                case int_types/* ["default"].UInt8 */.A.UInt8:
                case int_types/* ["default"].Int8 */.A.Int8:
                case int_types/* ["default"].UInt16 */.A.UInt16:
                case int_types/* ["default"].Int16 */.A.Int16:
                case int_types/* ["default"].UInt32 */.A.UInt32:
                case int_types/* ["default"].Int32 */.A.Int32:
                case float_types/* ["default"].Float32 */.A.Float32:
                case float_types/* ["default"].Float64 */.A.Float64:
                    switch (outputImage.imageType.componentType) {
                        ...
                        case float_types/* ["default"].Float64 */.A.Float64:
                            ...
                            break;
                        case int_types/* ["default"].UInt64 */.A.UInt64:
                            ...
                            break;
                        case int_types/* ["default"].Int64 */.A.Int64:
...
/* export default */ const cast_image = (castImage);
//# sourceMappingURL=cast-image.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/worker-pool/worker-pool.js
...
/* export default */ const worker_pool = (WorkerPool);
//# sourceMappingURL=worker-pool.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/worker-pool/index.js
// itk-wasm WebWorker API interfaces, data structures, and functions

//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/mesh-type.js
...
class MeshType {
    ...
    cellPixelType;
    cellPixelComponents;
    constructor(dimension = 2, pointComponentType = float_types/* ["default"].Float32 */.A.Float32, pointPixelComponentType = float_types/* ["default"].Float32 */.A.Float32, pointPixelType = pixel_types.Scalar, pointPixelComponents = 1, cellComponentType = int_types/* ["default"].Int32 */.A.Int32, cellPixelComponentType = float_types/* ["default"].Float32 */.A.Float32, cellPixelType = pixel_types.Scalar, cellPixelComponents = 1) {
        this.dimension = dimension;
...
/* export default */ const mesh_type = (MeshType);
//# sourceMappingURL=mesh-type.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/mesh.js
...
/* export default */ const interface_types_mesh = (Mesh);
//# sourceMappingURL=mesh.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/poly-data-type.js
...
class PolyDataType {
    ...
    cellPixelType;
    cellPixelComponents;
    constructor(pointPixelComponentType = float_types/* ["default"].Float32 */.A.Float32, pointPixelType = pixel_types.Scalar, pointPixelComponents = 1, cellPixelComponentType = float_types/* ["default"].Float32 */.A.Float32, cellPixelType = pixel_types.Scalar, cellPixelComponents = 1) {
        this.pointPixelComponentType = pointPixelComponentType;
        this.pointPixelType = pointPixelType;
        this.pointPixelComponents = pointPixelComponents;
        this.cellPixelComponentType = cellPixelComponentType;
...
/* export default */ const poly_data_type = (PolyDataType);
//# sourceMappingURL=poly-data-type.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/poly-data.js
...
/* export default */ const poly_data = (PolyData);
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/interface-types/index-common.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/index-common.js

//# sourceMappingURL=index-common.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/index-common.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/create-web-worker.js
...
async function createWebWorker(pipelineWorkerUrl) {
    ...
    if (workerUrl === null) {
        ...
        worker = new Worker(new URL(/* worker import */__webpack_require__.p + __webpack_require__.u(8745), __webpack_require__.b), Object.assign({}, { type: 'module' }, { type: undefined }));
    }
    else {
        if (workerUrl.startsWith('http')) {
            const response = await axios/* ["default"].get */.Ay.get(workerUrl, { responseType: 'blob' });
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/create-worker-proxy.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/internal/load-emscripten-module-main-thread.js
...
async function loadEmscriptenModuleMainThread(moduleRelativePathOrURL, baseUrl) {
    ...
    const response = await axios/* ["default"].get */.Ay.get(wasmBinaryPath, { responseType: 'arraybuffer' });
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/pipelines-base-url.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/pipeline-worker-url.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/run-pipeline.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/default-web-worker.js
...
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/pipeline/index.js
...
//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-dicom-tags.js
// @ts-nocheck
/**
...
/* export default */ const read_dicom_tags = (readDICOMTags);
//# sourceMappingURL=read-dicom-tags.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-dicom-tags-array-buffer.js
// @ts-nocheck
/**
 *
 * @deprecated Use readDicomTags from @itk-wasm/dicom instead
...
/* export default */ const read_dicom_tags_array_buffer = (readDICOMTagsArrayBuffer);
//# sourceMappingURL=read-dicom-tags-array-buffer.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-dicom-file-series.js
// @ts-nocheck
/**
...
/* export default */ const read_image_dicom_file_series = (readImageDICOMFileSeries);
//# sourceMappingURL=read-image-dicom-file-series.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-dicom-array-buffer-series.js
// @ts-nocheck
/**
 *
 * @deprecated Use readImageDicomFileSeries from @itk-wasm/dicom instead
...
/* export default */ const read_image_dicom_array_buffer_series = (readImageDICOMArrayBufferSeries);
//# sourceMappingURL=read-image-dicom-array-buffer-series.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/mesh-to-poly-data.js
// @ts-nocheck
/**
...
/* export default */ const mesh_to_poly_data = (meshToPolyData);
//# sourceMappingURL=mesh-to-poly-data.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/poly-data-to-mesh.js
// @ts-nocheck
/**
...
/* export default */ const poly_data_to_mesh = (polyDataToMesh);
//# sourceMappingURL=poly-data-to-mesh.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-array-buffer.js
// @ts-nocheck
/**
...
/* export default */ const read_image_array_buffer = (readImageArrayBuffer);
//# sourceMappingURL=read-image-array-buffer.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-blob.js
// @ts-nocheck
/**
...
/* export default */ const read_image_blob = (readImageBlob);
//# sourceMappingURL=read-image-blob.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-file.js
// @ts-nocheck
/**
...
/* export default */ const read_image_file = (readImageFile);
//# sourceMappingURL=read-image-file.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-image-file-series.js
// @ts-nocheck
/**
...
/* export default */ const read_image_file_series = (readImageFileSeries);
//# sourceMappingURL=read-image-file-series.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-mesh-array-buffer.js
// @ts-nocheck
/**
...
/* export default */ const read_mesh_array_buffer = (readMeshArrayBuffer);
//# sourceMappingURL=read-mesh-array-buffer.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/read-mesh-file.js
// @ts-nocheck
/**
...
/* export default */ const read_mesh_file = (readMeshFile);
//# sourceMappingURL=read-mesh-file.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/deprecated/index.js
...
//# sourceMappingURL=index.js.map
;// CONCATENATED MODULE: ../../../node_modules/itk-wasm/dist/index.js
