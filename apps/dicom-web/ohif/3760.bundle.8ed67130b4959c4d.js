"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[3760], {
35117(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export),
  v: () => (measurementTrackingMode)
});
/* import */ var i18next__rspack_import_0 = __webpack_require__(40680);
...
function _askTrackMeasurements(uiViewportDialogService, customizationService, viewportId) {
  return new Promise(function (resolve, reject) {
    ...
    const actions = [{
      ...
      type: 'secondary',
      text: i18next__rspack_import_0/* ["default"].t */.A.t('Common:No'),
      value: RESPONSE.CANCEL
    }, {
      id: 'prompt-begin-tracking-no-do-not-ask-again',
      type: 'secondary',
      text: i18next__rspack_import_0/* ["default"].t */.A.t('MeasurementTable:No, do not ask again'),
      value: RESPONSE.NO_NEVER
    }, {
      id: 'prompt-begin-tracking-yes',
      type: 'primary',
      text: i18next__rspack_import_0/* ["default"].t */.A.t('Common:Yes'),
...
28835(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var TrackedMeasurementsContext_promptBeginTracking = __webpack_require__(35117);
// EXTERNAL MODULE: ../../../extensions/cornerstone-dicom-sr/src/index.tsx + 16 modules
var cornerstone_dicom_sr_src = __webpack_require__(81107);
...
function hydrateStructuredReport({
  ...
  return new Promise((resolve, reject) => {
    const hydrationResult = (0,cornerstone_dicom_sr_src/* .hydrateStructuredReport */.$F)({
      servicesManager,
      extensionManager,
      commandsManager,
      appConfig
...
/* export default */ const TrackedMeasurementsContext_hydrateStructuredReport = (hydrateStructuredReport);
// EXTERNAL MODULE: ./state/index.js + 1 modules
var state = __webpack_require__(55461);
...
// Bound by consumer
{
  ...
  machineOptions.actions = Object.assign({}, machineOptions.actions, {
    ...
    clearAllMeasurements: (ctx, evt) => {
      const trackingContext = evt.trackedStudy ? {
        StudyInstanceUID: evt.trackedStudy,
        SeriesInstanceUIDs: [...(evt.trackedSeries || [])]
      } : undefined;
      measurementService.clearMeasurements(undefined, trackingContext ? {
        trackingContext
      } : undefined);
  ...
  machineOptions.guards = Object.assign({}, machineOptions.guards, {
    ...
    isSimplifiedConfig: (ctx, evt, condMeta) => {
      return appConfig?.measurementTrackingMode === TrackedMeasurementsContext_promptBeginTracking/* .measurementTrackingMode.SIMPLIFIED */.v.SIMPLIFIED;
    },
    simplifiedAndLoadSR: (ctx, evt, condMeta) => {
      return appConfig?.measurementTrackingMode === TrackedMeasurementsContext_promptBeginTracking/* .measurementTrackingMode.SIMPLIFIED */.v.SIMPLIFIED && evt.data?.isBackupSave === false;
    },
    hasDirtyAndSimplified: (ctx, evt, condMeta) => {
      ...
      return appConfig?.measurementTrackingMode === TrackedMeasurementsContext_promptBeginTracking/* .measurementTrackingMode.SIMPLIFIED */.v.SIMPLIFIED && hasDirtyMeasurements;
    }
  });
...
/* export default */ const src_getContextModule = (getContextModule);

},
34879(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: measurementTrackingMode

// EXTERNAL MODULE: ../../../extensions/measurement-tracking/src/getContextModule.tsx + 6 modules
var getContextModule = __webpack_require__(28835);
// EXTERNAL MODULE: ../../../node_modules/react/index.js
var react = __webpack_require__(86326);
// EXTERNAL MODULE: ../../../node_modules/prop-types/index.js
var prop_types = __webpack_require__(97598);
...
var thumbnailNoImageModalities = __webpack_require__(88555);
// EXTERNAL MODULE: ../../../extensions/default/src/Panels/StudyBrowser/PanelStudyBrowser.tsx + 3 modules
var PanelStudyBrowser = __webpack_require__(36341);
// EXTERNAL MODULE: ../../ui-next/src/index.ts + 3685 modules
...
function UntrackSeriesModal({
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "mt-4"
  }, /*#__PURE__*/react.createElement(ui_next_src/* .FooterAction.Right */.esu.Right, null, /*#__PURE__*/react.createElement(ui_next_src/* .FooterAction.Secondary */.esu.Secondary, {
    dataCY: "untracked-series-modal-cancel-button",
    onClick: hide
  }, "Cancel"), /*#__PURE__*/react.createElement(ui_next_src/* .FooterAction.Primary */.esu.Primary, {
...
function PanelStudyBrowserTracking({
  ...
  const getComponentType = ds => {
    if (thumbnailNoImageModalities/* .thumbnailNoImageModalities.includes */.w.includes(ds.Modality) || ds.unsupported || ds.thumbnailSrc === null) {
...
/* export default */ const PanelStudyBrowserTracking_getImageSrcFromImageId = (getImageSrcFromImageId);
...
function WrappedPanelStudyBrowserTracking() {
  ...
  const _requestDisplaySetCreationForStudy = default_src/* .requestDisplaySetCreationForStudy.bind */.Z.bind(null, dataSource);
...
/* export default */ const panels_PanelStudyBrowserTracking = (WrappedPanelStudyBrowserTracking);
...
const {
  ...
  filterAny
} = src/* .utils.MeasurementFilters */.Wp.MeasurementFilters;
function PanelMeasurementTableTracking(props) {
  ...
  const EmptyComponent = () => /*#__PURE__*/react.createElement("div", {
    ...
    title: "Measurements",
    isExpanded: false
  }, /*#__PURE__*/react.createElement(ui_next_src/* .MeasurementTable.Body */.VaM.Body, null)));
  const actions = {
    createSR: ({
      StudyInstanceUID
    }) => {
  ...
  }, /*#__PURE__*/react.createElement(cornerstone_src/* .StudySummaryFromMetadata */.x3, _extends({}, props, {
    actions: actions
  }))));
  return /*#__PURE__*/react.createElement(ui_next_src/* .ScrollArea */.FKN, null, /*#__PURE__*/react.createElement("div", {
    "data-cy": "trackedMeasurements-panel"
  }, /*#__PURE__*/react.createElement(cornerstone_src/* .PanelMeasurement */.re, {
    measurementFilter: measurementFilter,
    emptyComponent: EmptyComponent,
    sourceChildren: props.children
  }, /*#__PURE__*/react.createElement(cornerstone_src/* .StudyMeasurements */.B9, {
    grouping: props.grouping
  }, /*#__PURE__*/react.createElement(cornerstone_src/* .AccordionGroup.Trigger */._I.Trigger, {
    key: "trackingMeasurementsHeader",
    asChild: true
  }, /*#__PURE__*/react.createElement(Header, {
    key: "trackingHeadChild"
  })), /*#__PURE__*/react.createElement(cornerstone_src/* .MeasurementsOrAdditionalFindings */.CP, {
    key: "measurementsOrAdditionalFindings",
    activeStudyUID: trackedStudy,
    customHeader: cornerstone_src/* .StudyMeasurementsActions */._9,
    measurementFilter: measurementFilter,
    actions: actions
  })))));
}
/* export default */ const panels_PanelMeasurementTableTracking = (PanelMeasurementTableTracking);
...
function getPanelModule({
  ...
  return [{
    ...
    iconLabel: 'Studies',
    label: i18next/* ["default"].t */.A.t('SidePanel:Studies'),
    component: props => /*#__PURE__*/react.createElement(panels_PanelStudyBrowserTracking, props)
  }, {
    name: 'trackedMeasurements',
    iconName: 'tab-linear',
    iconLabel: 'Measure',
    label: i18next/* ["default"].t */.A.t('SidePanel:Measurements'),
...
const Component = /*#__PURE__*/react.lazy(() => {
  return __webpack_require__.e(/* import() */ 1206).then(__webpack_require__.bind(__webpack_require__, 77333));
});
...
function getViewportModule({
  ...
  return [{
    ...
    isReferenceViewable: cornerstone_src/* .utils.isReferenceViewable.bind */.Wp.isReferenceViewable.bind(null, servicesManager)
  }];
}
/* export default */ const src_getViewportModule = (getViewportModule);
;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/package.json
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-measurement-tracking"}')
;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/id.js

const id = package_namespaceObject.UU;

// EXTERNAL MODULE: ../../../extensions/measurement-tracking/src/contexts/TrackedMeasurementsContext/promptBeginTracking.js
var promptBeginTracking = __webpack_require__(35117);
...
/* export default */ const TrackedMeasurementsContext_promptHasDirtyAnnotations = (promptHasDirtyAnnotations);
;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/contexts/TrackedMeasurementsContext/promptHydrateStructuredReport.ts
...
function promptHydrateStructuredReport({
  ...
  return cornerstone_src/* .utils.promptHydrationDialog */.Wp.promptHydrationDialog({
    servicesManager,
    viewportId,
...
/* export default */ const TrackedMeasurementsContext_promptHydrateStructuredReport = (promptHydrateStructuredReport);
...
function promptTrackNewSeries({
  ...
  return new Promise(async function (resolve, reject) {
    const appConfig = extensionManager.appConfig;
    const showPrompt = appConfig?.measurementTrackingMode === promptBeginTracking/* .measurementTrackingMode.STANDARD */.v.STANDARD;
...
/* export default */ const TrackedMeasurementsContext_promptTrackNewSeries = (promptTrackNewSeries);
...
function promptTrackNewStudy({
  ...
  return new Promise(async function (resolve, reject) {
    const appConfig = extensionManager.appConfig;
    const standardMode = appConfig?.measurementTrackingMode === promptBeginTracking/* .measurementTrackingMode.STANDARD */.v.STANDARD;
    const simplifiedMode = appConfig?.measurementTrackingMode === promptBeginTracking/* .measurementTrackingMode.SIMPLIFIED */.v.SIMPLIFIED;
...
function _askTrackMeasurements(UIViewportDialogService, customizationService, viewportId) {
  return new Promise(function (resolve, reject) {
    ...
    const actions = [{
      type: 'cancel',
      text: i18next/* ["default"].t */.A.t('MeasurementTable:No'),
      value: promptTrackNewStudy_RESPONSE.CANCEL
    }, {
      type: 'secondary',
      text: i18next/* ["default"].t */.A.t('MeasurementTable:No, do not ask again'),
      value: promptTrackNewStudy_RESPONSE.NO_NOT_FOR_SERIES
    }, {
      type: 'primary',
      text: i18next/* ["default"].t */.A.t('MeasurementTable:Yes'),
...
/* export default */ const TrackedMeasurementsContext_promptTrackNewStudy = (promptTrackNewStudy);
...
/* export default */ const measurementTrackingPrompts = ({
  ...
  'measurement.promptLabelAnnotation': default_src/* .promptLabelAnnotation */.uR,
  'measurement.promptSaveReport': default_src/* .promptSaveReport */.MP,
...
;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/services/TrackedMeasurementsService/TrackedMeasurementsService.ts
...
/* export default */ const TrackedMeasurementsService_TrackedMeasurementsService = ((/* unused pure expression or super */ null && (TrackedMeasurementsService)));
;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/services/TrackedMeasurementsService/index.ts

;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/services/index.ts

;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/types/AppTypes.ts


;// CONCATENATED MODULE: ../../../extensions/measurement-tracking/src/types/index.ts
...
/* export default */ const measurement_tracking_src = (measurementTrackingExtension);
