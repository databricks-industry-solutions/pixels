"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([[2591,4819],{
...
function WrappedPanelStudyBrowserTracking() {
  ...
  const _requestDisplaySetCreationForStudy = default_src/* requestDisplaySetCreationForStudy */.Z.bind(null, dataSource);
...
function PanelMeasurementTableTracking(props) {
  ...
  }, /*#__PURE__*/react.createElement(cornerstone_src/* AccordionGroup */._I.Trigger, {
...
function getViewportModule({
  ...
  return [{
    ...
    isReferenceViewable: cornerstone_src/* utils */.Wp.isReferenceViewable.bind(null, servicesManager)
  }];
}
...
function promptHydrateStructuredReport({
  ...
  return cornerstone_src/* utils */.Wp.promptHydrationDialog({
    servicesManager,
    viewportId,
 ...
 */
class TrackedMeasurementsService extends src.PubSubService {
  constructor() {
    super(EVENTS);
    this._trackedSeries = [];
  }
