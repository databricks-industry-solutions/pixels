"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[7499], {
87110(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ tmtv_src),
  i: () => (/* reexport */ toolGroupIds)
});

;// CONCATENATED MODULE: ../../../extensions/tmtv/package.json
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-tmtv"}')
...
function getHangingProtocolModule() {
  ...
  if ((0,src/* .isNextViewportsEnabled */.qW)()) {
    [fusionAXIAL, fusionSAGITTAL, fusionCORONAL].forEach(viewport => {
      ...
      if (colormap) {
        colormap.opacity = src/* .NEXT_FUSION_PT_OPACITY */.yM;
      }
    });
  }
  return [{
...
function PanelPetSUV() {
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement("div", {
    ...
    defaultOpen: true
  }, /*#__PURE__*/react.createElement(ui_next_src/* .PanelSection.Header */.aUM.Header, null, t('Patient Information')), /*#__PURE__*/react.createElement(ui_next_src/* .PanelSection.Content */.aUM.Content, null, /*#__PURE__*/react.createElement("div", {
...
const handleROIThresholding_handleROIThresholding = async ({
  commandsManager,
  segmentationService
}) => {
...
var utils = __webpack_require__(81381);
...
function PanelRoiThresholdSegmentation() {
  ...
  } = (0,src/* .useActiveViewportSegmentationRepresentations */.c3)();
  ...
  (0,react.useEffect)(() => {
    const initialRun = async () => {
      for (const segmentationId of segmentationIds) {
        await handleROIThresholding_handleROIThresholding({
          segmentationId,
          commandsManager,
          segmentationService
        });
...
/* export default */ const PanelROIThresholdSegmentation = (PanelRoiThresholdSegmentation);
...
function PanelTMTV({
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(src/* .PanelSegmentation */.rE, {
...
function getPanelModule({
  ...
  const wrappedROIThresholdToolbox = () => {
    return /*#__PURE__*/react.createElement(default_src/* .Toolbox */.OO, {
      buttonSectionId: toolbarService.sections.roiThresholdToolbox,
      title: i18n_src/* ["default"].t */.A.t('ROIThresholdConfiguration:Threshold Tools')
    });
  };
...
/* export default */ const supportedTools = (['RectangleROIStartEndThreshold', 'CircleROIStartEndThreshold']);
;// CONCATENATED MODULE: ../../../extensions/tmtv/src/utils/measurementServiceMappings/RectangleROIStartEndThreshold.js


const RectangleROIStartEndThreshold_RectangleROIStartEndThreshold = {
  ...
  toMeasurement: (csToolsEventDetail, displaySetService, cornerstoneViewportService) => {
    ...
    const {
      ...
      SeriesInstanceUID,
      StudyInstanceUID
    } = (0,src/* .getSOPInstanceAttributes */.J4)(referencedImageId, cornerstoneViewportService, viewportId);
    let displaySet;
    if (SOPInstanceUID) {
...
/* export default */ const measurementServiceMappings_RectangleROIStartEndThreshold = (RectangleROIStartEndThreshold_RectangleROIStartEndThreshold);
;// CONCATENATED MODULE: ../../../extensions/tmtv/src/utils/measurementServiceMappings/CircleROIStartEndThreshold.js


const CircleROIStartEndThreshold_CircleROIStartEndThreshold = {
  toAnnotation: (measurement, definition) => {},
  /**
   * Maps cornerstone annotation event data to measurement service format.
   *
...
/* export default */ const measurementServiceMappings_CircleROIStartEndThreshold = (CircleROIStartEndThreshold_CircleROIStartEndThreshold);
...
/* export default */ const measurementServiceMappings_measurementServiceMappingsFactory = (measurementServiceMappingsFactory);
...
/* export default */ const getThresholdValue = (getThresholdValues);
...
const metadataProvider = core_src/* .classes.MetadataProvider */.Ly.MetadataProvider;
function dicomRTAnnotationExport(annotations) {
  const dataset = adapters_dist_esm/* .adaptersRT.Cornerstone3D.RTSS.generateRTSSFromAnnotations */.f_.Cornerstone3D.RTSS.generateRTSSFromAnnotations(annotations, metadataProvider, core_src.DicomMetadataStore);
...
/* export default */ const RTStructureSet = (dicomRTAnnotationExport);
...
const commandsModule_metadataProvider = core_src/* .classes.MetadataProvider */.Ly.MetadataProvider;
  ...
  const actions = {
    ...
    createNewLabelmapFromPT: async ({
      ...
      const segmentationId = await segmentationService.createLabelmapForDisplaySet(displaySet, {
        ...
        segments: {
          1: {
            label: `${i18n_src/* ["default"].t */.A.t('Segment')} 1`,
            active: true
          }
        }
      });
    ...
    setStartSliceForROIThresholdTool: () => {
      ...
      const focalPoint = (0,src/* .getViewportFocalPoint */.sH)(viewport);
    ...
    setEndSliceForROIThresholdTool: () => {
      ...
      const focalPointToEnd = (0,src/* .getViewportFocalPoint */.sH)(viewport);
      if (!focalPointToEnd) {
        return;
      }
    ...
    getSegmentationCSVReport: ({
      ...
      for (const segmentation of segmentations) {
        ...
        const referencedVolume = esm.utilities.segmentation.getReferenceVolumeForSegmentation(segmentationId);
        if (!referencedVolume) {
          report[id] = segReport;
          continue;
        }
        ...
        const instance = core_src/* ["default"].classes.MetadataProvider.get */.Ay.classes.MetadataProvider.get('instance', firstImageId);
        if (!instance) {
          report[id] = segReport;
          continue;
        }
...
/* export default */ const PanelROIThresholdSegmentation_ROIThresholdConfiguration = (ROIThresholdConfiguration);
...
function RectangleROIOptions() {
  ...
  const segmentations = (0,src/* .useSegmentations */.jo)();
...
/* export default */ const Panels_RectangleROIOptions = (RectangleROIOptions);
...
;// CONCATENATED MODULE: ../../../extensions/tmtv/src/toolGroupIds.ts
/**
...
/* export default */ const src_toolGroupIds = ((/* unused pure expression or super */ null && (toolGroupIds)));
;// CONCATENATED MODULE: ../../../extensions/tmtv/src/customizations/toolbarCustomization.ts



const {
  TOOLBAR_SECTIONS
} = core_src/* .ToolbarService */.hx;
...
const toolbarButtons = [{
  ...
  props: {
    icon: 'tool-annotate',
    label: i18next/* ["default"].t */.A.t('Buttons:Arrow Annotate'),
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Arrow Annotate Tool'),
    commands: setToolActiveToolbar,
    evaluate: 'evaluate.cornerstoneTool'
  }
}, {
  ...
  props: {
    ...
    tooltip: i18next/* ["default"].t */.A.t('Buttons:Ellipse Tool'),
    commands: setToolActiveToolbar,
    evaluate: 'evaluate.cornerstoneTool'
  }
}, {
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Rectangle ROI Threshold'),
    commands: setToolActiveToolbar,
    evaluate: ['evaluate.cornerstone.segmentation', {
      name: 'evaluate.cornerstoneTool',
      disabledText: i18next/* ["default"].t */.A.t('Buttons:Select the PT Axial to enable this tool')
    }],
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Brush'),
    evaluate: [{
      name: 'evaluate.cornerstone.segmentation',
      toolNames: ['CircularBrush', 'SphereBrush'],
      disabledText: i18next/* ["default"].t */.A.t('Buttons:Create new segmentation to enable this tool.')
    }, {
      name: 'evaluate.cornerstone.segmentation.synchronizeDrawingRadius',
      radiusOptionId: 'brush-radius'
    }],
    options: [{
      name: i18next/* ["default"].t */.A.t('Buttons:Radius (mm)'),
      id: 'brush-radius',
      type: 'range',
      ...
      name: i18next/* ["default"].t */.A.t('Buttons:Shape'),
      type: 'radio',
      id: 'brush-mode',
      value: 'CircularBrush',
      values: [{
        ...
        value: 'SphereBrush',
        label: i18next/* ["default"].t */.A.t('Buttons:Sphere')
      }],
      commands: 'setToolActiveToolbar'
    }]
  }
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Eraser'),
    evaluate: [{
      name: 'evaluate.cornerstone.segmentation',
  ...
  props: {
    ...
    label: i18next/* ["default"].t */.A.t('Buttons:Threshold Tool'),
    evaluate: [{
      name: 'evaluate.cornerstone.segmentation',
    ...
    options: [{
      ...
      name: i18next/* ["default"].t */.A.t('Buttons:Threshold'),
      type: 'radio',
      id: 'dynamic-mode',
      value: 'ThresholdRange',
      values: [{
        value: 'ThresholdDynamic',
        label: i18next/* ["default"].t */.A.t('Buttons:Dynamic')
      }, {
        value: 'ThresholdRange',
        label: i18next/* ["default"].t */.A.t('Buttons:Range')
      }],
      commands: ({
        value,
        commandsManager
      ...
      name: i18next/* ["default"].t */.A.t('ROIThresholdConfiguration:ThresholdRange'),
      type: 'double-range',
      id: 'threshold-range',
      min: 0,
      max: 50,
...
/* export default */ const customizations_toolbarCustomization = (toolbarCustomization);
;// CONCATENATED MODULE: ../../../extensions/tmtv/src/getCustomizationModule.ts
...
function getCustomizationModule() {
  return [{
    name: 'default',
    value: {
      ...customizations_toolbarCustomization
    }
  }];
}
...
/* export default */ const tmtv_src = (tmtvExtension);
