"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[1936], {
69571(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
;// CONCATENATED MODULE: ../../../modes/redaction-viewer/package.json
var package_namespaceObject = JSON.parse('{"UU":"@ohif/mode-redaction-viewer"}')
;// CONCATENATED MODULE: ../../../modes/redaction-viewer/src/id.js
/*
...
;// CONCATENATED MODULE: ../../../modes/redaction-viewer/src/initToolGroups.js
const colours = {
...
;// CONCATENATED MODULE: ../../../modes/redaction-viewer/src/toolbarButtons.js
...
// tool defs
{
  ...
  props: {
    ...
    listeners: {
      [src/* .ViewportGridService.EVENTS.ACTIVE_VIEWPORT_ID_CHANGED */.sI.EVENTS.ACTIVE_VIEWPORT_ID_CHANGED]: callbacks('LabelmapSlicePropagation'),
      [src/* .ViewportGridService.EVENTS.VIEWPORTS_READY */.sI.EVENTS.VIEWPORTS_READY]: callbacks('LabelmapSlicePropagation')
    },
    commands: 'toggleEnabledDisabledToolbar'
  }
}, {
  ...
  props: {
    ...
    commands: 'setToolActiveToolbar',
    listeners: {
      [src/* .ViewportGridService.EVENTS.ACTIVE_VIEWPORT_ID_CHANGED */.sI.EVENTS.ACTIVE_VIEWPORT_ID_CHANGED]: callbacks('MarkerLabelmap'),
      [src/* .ViewportGridService.EVENTS.VIEWPORTS_READY */.sI.EVENTS.VIEWPORTS_READY]: callbacks('MarkerLabelmap')
    },
    options: [{
      name: 'Marker Mode',
      type: 'radio',
...
;// CONCATENATED MODULE: ../../../modes/redaction-viewer/src/index.ts
...
function modeFactory({
  ...
  return {
    ...
    displayName: i18next/* ["default"].t */.A.t('Modes:Redaction Tool'),
    /**
     * Lifecycle hooks
     */
...
/* export default */ const redaction_viewer_src = (mode);
