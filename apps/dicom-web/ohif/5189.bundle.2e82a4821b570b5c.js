"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[5189], {
40292(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var src = __webpack_require__(25581);
...
/* export default */ const ViewportOverlay_listComponentGenerator = (listComponentGenerator);
...
const generateFromConfig = ({
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, topLeft && topLeft.length > 0 && /*#__PURE__*/react.createElement("div", {
    ...
    ...props,
    list: topLeft,
    itemGenerator: ViewportOverlay_itemGenerator
...
const ViewportOverlay_itemGenerator = props => {
  const {
    item
  } = props;
  const {
...
/* export default */ const ViewportOverlay = (generateFromConfig);
  ...
  const installOpenLayersRenderer = (0,react.useCallback)(async (container, displaySet) => {
    const loadViewer = async metadata => {
      ...
      metadata.forEach(m => {
        ...
        const inst = (0,src/* .cleanDenaturalizedDataset */.wZ)(dcmjs_es/* ["default"].data.DicomMetaDictionary.denaturalizeDataset */.Ay.data.DicomMetaDictionary.denaturalizeDataset(m), {
...
/* export default */ const src_DicomMicroscopyViewport = (DicomMicroscopyViewport);
