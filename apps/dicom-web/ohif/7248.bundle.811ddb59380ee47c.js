"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[7248], {
14126(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  bY: () => (CodingSchemeDesignators),
  n7: () => (CodeNameCodeSequenceValues),
  sh: () => (SCOORDTypes)
});
/* import */ var _cornerstonejs_adapters__rspack_import_0 = __webpack_require__(65419);

const {
  CodeScheme: Cornerstone3DCodeScheme
} = _cornerstonejs_adapters__rspack_import_0/* .adaptersSR.Cornerstone3D */.QX.Cornerstone3D;
const SCOORDTypes = {
  POINT: 'POINT',
...
const RelationshipType = (/* unused pure expression or super */ null && ({
  INFERRED_FROM: 'INFERRED FROM',
  CONTAINS: 'CONTAINS'
}));
const enums = (/* unused pure expression or super */ null && ({
  CodeNameCodeSequenceValues,
  CodingSchemeDesignators,
  RelationshipType,
  SCOORDTypes
}));
/* unused export default */ var __rspack_default_export = ((/* unused pure expression or super */ null && (enums)));

},
81107(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var esm = __webpack_require__(65419);
// EXTERNAL MODULE: ../../../node_modules/@cornerstonejs/tools/dist/esm/index.js
var dist_esm = __webpack_require__(55526);
// EXTERNAL MODULE: ../../../node_modules/@cornerstonejs/core/dist/esm/index.js + 1 modules
var core_dist_esm = __webpack_require__(88479);
...
var enums = __webpack_require__(14126);
...
function getRenderableData({
  ...
  let renderableData = [];
  switch (GraphicType) {
    case enums/* .SCOORDTypes.POINT */.sh.POINT:
    case enums/* .SCOORDTypes.MULTIPOINT */.sh.MULTIPOINT:
    case enums/* .SCOORDTypes.POLYLINE */.sh.POLYLINE:
      {
    ...
    case enums/* .SCOORDTypes.CIRCLE */.sh.CIRCLE:
      {
        ...
        const radius = gl_matrix_esm/* .vec3.distance */.eR.Io(center, onPerimeter);
        ...
        const firstAxisStart = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.scaleAndAdd */.eR.Ln(firstAxisStart, center, columnCosines, radius);
        const firstAxisEnd = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.scaleAndAdd */.eR.Ln(firstAxisEnd, center, columnCosines, -radius);
        const secondAxisStart = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.scaleAndAdd */.eR.Ln(secondAxisStart, center, rowCosines, radius);
        const secondAxisEnd = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.scaleAndAdd */.eR.Ln(secondAxisEnd, center, rowCosines, -radius);
        renderableData = [firstAxisStart, firstAxisEnd, secondAxisStart, secondAxisEnd];
        break;
      }
    case enums/* .SCOORDTypes.ELLIPSE */.sh.ELLIPSE:
      {
        ...
        const majorAxisStart = gl_matrix_esm/* .vec3.fromValues */.eR.fA(...pointsWorld[0]);
        const majorAxisEnd = gl_matrix_esm/* .vec3.fromValues */.eR.fA(...pointsWorld[1]);
        const minorAxisStart = gl_matrix_esm/* .vec3.fromValues */.eR.fA(...pointsWorld[2]);
        const minorAxisEnd = gl_matrix_esm/* .vec3.fromValues */.eR.fA(...pointsWorld[3]);
        const majorAxisVec = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.sub */.eR.jb(majorAxisVec, majorAxisEnd, majorAxisStart);

        // normalize majorAxisVec to avoid scaling issues
        gl_matrix_esm/* .vec3.normalize */.eR.S8(majorAxisVec, majorAxisVec);
        const minorAxisVec = gl_matrix_esm/* .vec3.create */.eR.vt();
        gl_matrix_esm/* .vec3.sub */.eR.jb(minorAxisVec, minorAxisEnd, minorAxisStart);
        gl_matrix_esm/* .vec3.normalize */.eR.S8(minorAxisVec, minorAxisVec);
        const imagePlaneModule = core_dist_esm.metaData.get('imagePlaneModule', imageId);
        if (!imagePlaneModule) {
        ...
        const columnCosinesVec = gl_matrix_esm/* .vec3.fromValues */.eR.fA(...columnCosines);
        const projectedMajorAxisOnColVec = Math.abs(gl_matrix_esm/* .vec3.dot */.eR.Om(columnCosinesVec, majorAxisVec));
        const projectedMinorAxisOnColVec = Math.abs(gl_matrix_esm/* .vec3.dot */.eR.Om(columnCosinesVec, minorAxisVec));
...
/* export default */ const utils_getRenderableData = (getRenderableData);
...
/* export default */ const tools_toolNames = (toolNames);
...
const {
  MeasurementReport
} = esm/* .adaptersSR.Cornerstone3D */.QX.Cornerstone3D;
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-cornerstone-dicom-sr"}')
...
function addInstances(instances, _displaySetService) {
  ...
  src/* .utils.sortStudyInstances */.Wp.sortStudyInstances(this.instances);
...
function _getDisplaySetsFromSeries(instances, servicesManager, extensionManager) {
  ...
  const isImagingMeasurementReport = ConceptNameCodeSequence?.CodeValue === enums/* .CodeNameCodeSequenceValues.ImagingMeasurementReport */.n7.ImagingMeasurementReport;
  const displaySet = {
    Modality: 'SR',
    ...
    predecessorImageId,
    addInstances,
    label: SeriesDescription || `${i18n_src/* ["default"].t */.A.t('Series')} ${SeriesNumber} - ${i18n_src/* ["default"].t */.A.t('SR')}`
  };
...
async function _load(srDisplaySet, servicesManager, extensionManager) {
  ...
  const displaySetsForSRPass = src/* .utils.sortDisplaySetsCopy */.Wp.sortDisplaySetsCopy(displaySetService.activeDisplaySets, {
...
function _getMeasurements(ImagingMeasurementReportContentSequence) {
  const ImagingMeasurements = ImagingMeasurementReportContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.ImagingMeasurements */.n7.ImagingMeasurements);
  if (!ImagingMeasurements) {
    return [];
  }
  const MeasurementGroups = _getSequenceAsArray(ImagingMeasurements.ContentSequence).filter(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.MeasurementGroup */.n7.MeasurementGroup);
...
function _getMergedContentSequencesByTrackingUniqueIdentifiers(MeasurementGroups) {
  ...
  MeasurementGroups.forEach(MeasurementGroup => {
    ...
    const TrackingUniqueIdentifierItem = ContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.TrackingUniqueIdentifier */.n7.TrackingUniqueIdentifier);
    ...
    if (mergedContentSequencesByTrackingUniqueIdentifiers[trackingUniqueIdentifier] === undefined) {
      ...
      ContentSequence.forEach(item => {
        if (item.ConceptNameCodeSequence.CodeValue !== enums/* .CodeNameCodeSequenceValues.TrackingUniqueIdentifier */.n7.TrackingUniqueIdentifier) {
...
function _processTID1410Measurement(mergedContentSequence) {
  ...
  const TrackingIdentifierContentItem = mergedContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.TrackingIdentifier */.n7.TrackingIdentifier);
  if (!graphicItem) {
  ...
  const findingSites = mergedContentSequence.filter(item => item.ConceptNameCodeSequence.CodingSchemeDesignator === enums/* .CodingSchemeDesignators.SCT */.bY.SCT && item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.FindingSiteSCT */.n7.FindingSiteSCT);
  if (findingSites.length) {
    measurement.labels.push({
      label: enums/* .CodeNameCodeSequenceValues.FindingSiteSCT */.n7.FindingSiteSCT,
...
function _processNonGeometricallyDefinedMeasurement(mergedContentSequence) {
  ...
  const UIDREFContentItem = mergedContentSequence.find(group => group.ValueType === 'UIDREF');
  const TrackingIdentifierContentItem = mergedContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.TrackingIdentifier */.n7.TrackingIdentifier);
  const finding = mergedContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.Finding */.n7.Finding);
  const findingSites = mergedContentSequence.filter(item => item.ConceptNameCodeSequence.CodingSchemeDesignator === enums/* .CodingSchemeDesignators.SRT */.bY.SRT && item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.FindingSite */.n7.FindingSite);
  ...
  if (finding && enums/* .CodingSchemeDesignators.CornerstoneCodeSchemes.includes */.bY.CornerstoneCodeSchemes.includes(finding.ConceptCodeSequence.CodingSchemeDesignator) && finding.ConceptCodeSequence.CodeValue === Cornerstone3DCodeScheme.codeValues.CORNERSTONEFREETEXT) {
    measurement.labels.push({
...
function _getReferencedImagesList(ImagingMeasurementReportContentSequence) {
  const ImageLibrary = ImagingMeasurementReportContentSequence.find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.ImageLibrary */.n7.ImageLibrary);
  if (!ImageLibrary) {
    return [];
  }
  const ImageLibraryGroup = _getSequenceAsArray(ImageLibrary.ContentSequence).find(item => item.ConceptNameCodeSequence.CodeValue === enums/* .CodeNameCodeSequenceValues.ImageLibraryGroup */.n7.ImageLibraryGroup);
...
/* export default */ const src_getHangingProtocolModule = ((/* unused pure expression or super */ null && (getHangingProtocolModule)));
...
/* export default */ const utils_getFilteredCornerstoneToolState = (getFilteredCornerstoneToolState);
...
function hydrateStructuredReport({
  ...
  const instance = src.DicomMetadataStore.getInstance(studyUID, seriesUID, sopUID);
...
function chooseDisplaySet(displaySets, reference) {
  ...
  const sortedDisplaySets = src/* ["default"].utils.sortDisplaySetsCopy */.Ay.utils.sortDisplaySetsCopy(displaySets);
...
function centerOf(points) {
  ...
  const center = gl_matrix_esm/* .vec3.create */.eR.vt();
  for (const point of points) {
    gl_matrix_esm/* .vec3.scaleAndAdd */.eR.Ln(center, center, point, scale);
  }
  return center;
}
...
var dicomSRModule = __webpack_require__(91473);
...
var createReferencedImageDisplaySet = __webpack_require__(81444);
...
const Component = /*#__PURE__*/react.lazy(() => {
  return __webpack_require__.e(/* import() */ 9068).then(__webpack_require__.bind(__webpack_require__, 44087));
});
...
/* export default */ const cornerstone_dicom_sr_src = (dicomSRExtension);

// Put static exports here so they can be type checked


},
91473(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  eF: () => (getTrackingUniqueIdentifiersForElement),
  m1: () => (setTrackingUniqueIdentifiersForElement)
});
...
81444(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (__rspack_default_export)
});
/* import */ var _ohif_core__rspack_import_0 = __webpack_require__(50679);

const ImageSet = _ohif_core__rspack_import_0/* .classes.ImageSet */.Ly.ImageSet;
