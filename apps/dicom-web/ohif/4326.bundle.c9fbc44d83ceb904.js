"use strict";
(globalThis["rspackChunk"] = globalThis["rspackChunk"] || []).push([[4326], {
39925(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var package_namespaceObject = JSON.parse('{"UU":"@ohif/extension-monai-label"}')
...
class BaseTab extends react.Component {
  constructor(props) {
    ...
    this.notification = new src/* .UINotificationService */.v4();
    this.uiModelService = new src/* .UIModalService */.zo();
...
class MonaiLabelClient {
  ...
  static api_get(url) {
    ...
    return axios/* ["default"].get */.Ay.get(url).then(function (response) {
  ...
  static api_delete(url) {
    ...
    return axios/* ["default"]["delete"] */.Ay["delete"](url).then(function (response) {
      console.debug(response);
      return response;
    }).catch(function (error) {
      return error;
  ...
  static api_post_data(url, data, responseType) {
    ...
    return axios/* ["default"].post */.Ay.post(url, data, {
  ...
  static api_put_data(url, data, responseType = 'json') {
    ...
    return axios/* ["default"].put */.Ay.put(url, data, {
      responseType: responseType,
      headers: {
        accept: ['application/json', 'multipart/form-data']
      }
...
class SegmentationReader {
  static parseNrrdData(data) {
    let nrrdfile = nrrd/* .parse */.q(data);
...
class SettingsTable extends react.Component {
  ...
  render() {
    ...
    }, /*#__PURE__*/react.createElement(ui_next_src/* .Icons.ToolReset */.FI1.ToolReset, {
      width: "12px",
      height: "12px"
...
/* export default */ const OptionsInputDialog = (optionsInputDialog);
...
/* export default */ const monai_label_src = ({
  id: id_id,
