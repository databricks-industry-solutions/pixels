...
def dicom_plot_outer(iterator: Iterator[Tuple[pd.Series, pd.Series]]) -> Iterator[pd.Series]:
    ...
    def dicom_plot(
        path: str, anon: bool = False, save_folder="/dbfs/FileStore/plots/pixels", figsize=(20.0, 20.0)
    ) -> str:
...
class DicomPlot:
    ...
    def display(self):
        ...
        lst = (
            ...
            .withColumn("plot", dicom_plot_pandas_udf(col(self._inputCol), col("is_anon"), lit(save_folder)))
