"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[3658],{
...
var default_src = __webpack_require__(18894);
...
class MicroscopyService extends core_src/* PubSubService */.Rc {
  ...
  _potentiallyLoadSR(StudyInstanceUID, displaySets) {
    const studyMetadata = core_src/* DicomMetadataStore */.H8.getStudy(StudyInstanceUID);
...
function MicroscopyPanel(props) {
  ...
  const onDeleteCurrentSRHandler = async () => {
    try {
      ...
      // TODO: studies?
      const study = core_src/* DicomMetadataStore */.H8.getStudy(StudyInstanceUID);
...
function _getDisplaySetsFromSeries(instances, servicesManager, extensionManager) {
  ...
  const naturalizedDataset = core_src/* DicomMetadataStore */.H8.getSeries(instance.StudyInstanceUID, instance.SeriesInstanceUID).instances[0];
...
const Component = /*#__PURE__*/react.lazy(() => {
  return __webpack_require__.e(/* import() */ 8228).then(__webpack_require__.bind(__webpack_require__, 48228));
});
