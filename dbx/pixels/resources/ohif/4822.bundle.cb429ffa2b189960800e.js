(self["webpackChunk"] = self["webpackChunk"] || []).push([[4822],{
...
;// CONCATENATED MODULE: ../../../extensions/default/src/DatabricksPixelsDicom/findIndexOfString.ts
...
;// CONCATENATED MODULE: ../../../extensions/default/src/DatabricksPixelsDicom/fixMultipart.ts
...
;// CONCATENATED MODULE: ../../../extensions/default/src/DatabricksPixelsDicom/StaticWadoClient.ts
...
function processResults(qidoStudies) {
  ...
  qidoStudies.forEach(qidoStudy => {
    studies.push({
      ...
      mrn: qidoStudy[4] || '',
      // medicalRecordNumber
      patientName: qidoStudy[5].includes("Alphabetic") ? src.utils.formatPN(getName(JSON.parse(qidoStudy[5]))) : "",
...
;// CONCATENATED MODULE: ../../../extensions/default/src/DatabricksPixelsDicom/multiframeImageLoader.js
...
class MultiframeImageLoaderService {
  ...
  async fetchFrame(fileUrl, frameNumber) {
    try {
      ...
      let metadata = esm.metaData.get('instance', fileUrl);
      if (!metadata) {
        const metadataResponse = await fetch(`${fileUrl.replace('multiframe:', '')}/metadata`);
      ...
      const frameResponse = await fetch(`${fileUrl.replace('multiframe:', '')}&frame=${frameNumber}`);
      ...
      const image = {
        ...
        color: metadata.PhotometricInterpretation !== 'MONOCHROME1' && metadata.PhotometricInterpretation !== 'MONOCHROME2',
