"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[810,8402],{
  ...
  const actions = {
    ...
    getSegmentationCSVReport: ({
      ...
      for (const segmentation of segmentations) {
        ...
        const referencedVolume = esm.utilities.segmentation.getReferenceVolumeForSegmentationVolume(segmentationId);
        if (!referencedVolume) {
          report[id] = segReport;
          continue;
        }
