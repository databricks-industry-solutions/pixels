"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([[2591,8583],{
...
function PanelTMTV({
  ...
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(cornerstone_src/* PanelSegmentation */.rE, {
...
const RectangleROIStartEndThreshold = {
  ...
  toMeasurement: (csToolsEventDetail, displaySetService, cornerstoneViewportService) => {
    ...
    const {
      ...
      SeriesInstanceUID,
      StudyInstanceUID
    } = (0,cornerstone_src/* getSOPInstanceAttributes */.J4)(referencedImageId, cornerstoneViewportService, viewportId);
    let displaySet;
    if (SOPInstanceUID) {
