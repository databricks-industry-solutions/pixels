(self["webpackChunk"] = self["webpackChunk"] || []).push([[3353],{
...
function postProcessDecodedPixels(imageFrame, options, start, decodeConfig) {
    ...
    if (type && options.preScale.enabled && !disableScale) {
        ...
        invalidType = !(0,getPixelDataTypeFromMinMax/* validatePixelDataType */.r)(minAfterScale, maxAfterScale, typedArrayConstructors[type]);
    }
    if (type && !invalidType) {
