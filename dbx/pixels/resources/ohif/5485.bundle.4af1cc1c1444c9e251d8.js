...
// UNUSED EXPORTS: NON_IMAGE_MODALITIES, dicomPmap, dicomSeg, dicompdf, dicomsr, dicomvideo, initToolGroups, isValidMode, layoutTemplate, modeFactory, onModeEnter, onModeExit, sopClassHandlers, toolbarButtons, toolbarSections
...
const toolbarSections = {
  [TOOLBAR_SECTIONS.primary]: ['MeasurementTools', 'Zoom', 'Pan', 'TrackballRotate', 'WindowLevel', 'Capture', 'VLMAnalyzer', 'Layout', 'Crosshairs', 'MoreTools'],
