...
var src = __webpack_require__(37681);
...
/* unused harmony import specifier */ var cornerstone;
  ...
  const installOpenLayersRenderer = (0,react.useCallback)(async (container, displaySet) => {
    const loadViewer = async metadata => {
      ...
      metadata.forEach(m => {
        ...
        const inst = (0,src/* cleanDenaturalizedDataset */.wZ)(dcmjs_es/* default.data */.Ay.data.DicomMetaDictionary.denaturalizeDataset(m), {
