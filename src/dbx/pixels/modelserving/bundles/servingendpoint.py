...
class MonaiLabelBundlesTransformer(Transformer):
    """
    ...
    - endpointName: The name of the MONAILabel serving endpoint with bundle models to use. Default is "pixels-monai-uc".
