...
# `databricks.labs.pixels` Solution Accelerator
...
```python
# imports
from databricks.labs.pixels import Catalog                       # 01
from databricks.labs.pixels.dicom import *                       # 02
...
|----------------------|-------------------------------------|-------------------------------|---------------------------------------------------------|
| databricks.labs.pixels    | Scale out image processong Spark    | Databricks                    | https://github.com/databricks-industry-solutions/pixels |
