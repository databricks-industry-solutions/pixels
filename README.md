...
# `mymodule.pixels` Solution Accelerator
...
```python
# imports
from mymodule.pixels import Catalog                       # 01
from mymodule.pixels.dicom import *                       # 02
...
|----------------------|-------------------------------------|-------------------------------|---------------------------------------------------------|
| mymodule.pixels    | Scale out image processong Spark    | Databricks                    | https://github.com/databricks-industry-solutions/pixels |
