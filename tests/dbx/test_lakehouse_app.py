...
# Mock Databricks dependencies before any imports that might trigger connectivity
@pytest.fixture(autouse=True)
def mock_databricks_dependencies():
    """Mock all Databricks dependencies to prevent cluster connectivity requirements."""
