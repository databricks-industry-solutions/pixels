...
class TestPromptClass:
    ...
    def test_prompt_default_use_case(self):
        ...
        prompt = Prompt(name="test", content="content", description="desc", prompt_type="user")
...
class TestPromptFromFile:
    ...
    def test_from_file_basic(self, tmp_path):
        ...
        prompt = Prompt.from_file(str(prompt_file), prompt_type="system", use_case="test")
    ...
    def test_from_file_with_description(self, tmp_path):
        ...
        prompt = Prompt.from_file(str(prompt_file), prompt_type="user", use_case="test")
    ...
    def test_from_file_custom_name(self, tmp_path):
        ...
        prompt = Prompt.from_file(
            str(prompt_file), name="custom_name", prompt_type="system", use_case="test"
        )
...
class TestPromptTypes:
    ...
    def test_valid_prompt_types(self):
        ...
        system_prompt = Prompt(
            name="sys", content="c", description="d", prompt_type="system", use_case="test"
        )
        assert system_prompt.prompt_type == "system"

        user_prompt = Prompt(
            name="usr", content="c", description="d", prompt_type="user", use_case="test"
        )
